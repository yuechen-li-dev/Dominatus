...
- [`samples/Dominatus.MonoGameRtsDemo`](samples/Dominatus.MonoGameRtsDemo) — a 1080p visual RTS-style behavioral-AI demo using MonoGameConn with 25 Dominion ships and 25 Collective ships by default. It shows a larger fleet-scale behavior view than the small FishTank MonoGame sample; RTSBenchmark remains the authoritative CPU benchmark. Design notes: [MonoGame RTS demo](docs/samples/SAMPLE_MONOGAME_RTS_DEMO.md).
